...
function WebsitePage() {
    ...
    return (
        <Paper sx={{ p: 3 }}>
            ...
            <Box sx={{ my: 4 }}>
                <Typography variant="h6" gutterBottom>Section Backgrounds</Typography>
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    Add specific images to sit behind the various sections (used in premium templates).
                </Typography>
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                        <TextField 
                            name="aboutSectionImageUrl" label="About Section Background" 
                            value={fullSettings.aboutSectionImageUrl || ''} onChange={handleInputChange} fullWidth 
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField 
                            name="menuSectionImageUrl" label="Menu Section Background" 
                            value={fullSettings.menuSectionImageUrl || ''} onChange={handleInputChange} fullWidth 
                        />
                    </Grid>
                    {/* ✅ ADDED RESERVATION BACKGROUND */}
                    <Grid item xs={12} sm={6}>
                        <TextField 
                            name="reservationSectionImageUrl" label="Reservation Section Background" 
                            value={fullSettings.reservationSectionImageUrl || ''} onChange={handleInputChange} fullWidth 
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField 
                            name="contactSectionImageUrl" label="Contact/Footer Background" 
                            value={fullSettings.contactSectionImageUrl || ''} onChange={handleInputChange} fullWidth 
                        />
                    </Grid>
                </Grid>
            </Box>
